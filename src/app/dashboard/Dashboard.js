...
const Dashboard = () => {
  ...
  useEffect(() => {
    ...
    new TradingView.widget(
      ...
      "container_id": "tradingview_eef71"
      }
    )`;
    
    script1.innerHTML = script1_content;
    document.getElementById("tradingview-chart1").appendChild(_script);
    document.getElementById("tradingview-chart1").appendChild(script1);

    const script2 = document.createElement('script');
    script2.src = 'https://s3.tradingview.com/external-embedding/embed-widget-forex-cross-rates.js';
    script2.async = true;
    let chatSettings = {
      "width": "100%",
      "height": "100%",
        ...
        <div className="row ">
          <div className="col-12 p-5 m-auto">
            ...
            <div className="tradingview-widget-container" id='tradingview-chart2' style={{width: "100%", height: "100%"}}>
              ...
              <div className="tradingview-widget-copyright"><a href="https://www.tradingview.com/markets/currencies/forex-cross-rates/" rel="noopener" target="_blank"><span className="blue-text">Exchange Rates</span></a> by TradingView</div>
              {/* chart script goes here */}
